...
　![这里写图片描述](image/180908_8.png)

- Average-pooling layer(平均池化):

　![这里写图片描述](image/180908_9.png)
　
...
　　 $M$ :`mask`矩阵，与$X$大小相同，用来标记$X$中最大元素的位置．在与$X$中最大元素相同位置标记为１，其他元素为０．　
